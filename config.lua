	...
	if imgui.BeginTabItem("Editor##beattoolsConfig") then
		configHelpers.treeNode("Visuals", function()
			configHelpers.treeNode("General", function()
				...
				configHelpers.treeNode("Editor Colors", function()
			...
			configHelpers.treeNode("Windows", function()
				...
				imgui.Separator()
				configHelpers.input("textPopOut")
				imgui.Separator()
			...
			configHelpers.treeNode("Markers", function()
				...
				configHelpers.condTreeNode("Text Colors", "showParam", "none", false, function()
					configHelpers.input("shadow")
					configHelpers.input("fgColor")
					configHelpers.input("bgColor")
				end)
				imgui.Separator()
				configHelpers.input("invalidTags")
			end)
		...
		configHelpers.treeNode("Features", function()
			...
			configHelpers.treeNode("Features", function()
				...
				imgui.Separator()
				configHelpers.input("placeNoDuration")
				configHelpers.input("betterHoldPlacing")
				configHelpers.input("betterHoldDragging")
				if mod.config.betterHoldDragging then configHelpers.input("holdSwapping") end
				imgui.Separator()
				...
				configHelpers.input("ctrlSelectKey")
				imgui.Separator()
			...
			configHelpers.treeNode("Hotkeys", function()
				...
				configHelpers.input("selectNone")
